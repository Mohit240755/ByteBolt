...
const Mens6 = () => {
    return (
        ...
        <div className="p-6 bg-gray-100" >
          <h1 className="text-center pt-3 border   bg-gradient-to-r from-slate-700 via-gray-600 to-zinc-500 text-white h-20 text-5xl font-bold font-serif">Puma Product</h1>
            ...
            {pumaProducts.map((product) => (
              <div key={product.id} className="M border-gray-200 rounded-lg shadow-lg p-2 w-75 ">
                ...
                <div className="flex justify-center gap-10 mt-5">
                  <Link to={`/men6/${product.id}`}><button className="border rounded-2xl h-10 w-60   bg-gradient-to-r from-slate-700 via-gray-600 to-zinc-500 text-white hover:bg-gray-500 font-semibold">
                    BUY
                  </button></Link>
                </div>
              </div>
