...
const Meni5 = () => {
  ...
  const product = pumaProducts.find(p => p.id === Number(id));
        ...
        <div className="flex rounded-2xl   justify-center bg-yellow-50 items-center">
          <div className="cart flex ">
            <div className="w-1/2 h-full p-5">
              <img src={product.image} alt="no" className="w-full h-150
                     object-contain pr-20 rounded-3xl" />
            </div>
