...
const Meni8 = () => {
  ...
  const product = mensTshirts.find(p => p.id === Number(id));
            ...
            <div className="w-1/2 pt-10">
              ...
              <div>
                ...
                <div className="flex gap-10 mt-5">
                  ...
                  <button
                  onClick={handleClick} className="flex items-center gap-3 border mt-5 rounded-2xl px-10 h-10 w-50 bg-emerald-200 hover:bg-emerald-500 transition-all text-sm">
